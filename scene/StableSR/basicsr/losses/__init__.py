...
from scene.StableSR.basicsr.utils.registry import LOSS_REGISTRY
...
_model_modules = [importlib.import_module(f'scene.StableSR.basicsr.losses.{file_name}') for file_name in loss_filenames]
